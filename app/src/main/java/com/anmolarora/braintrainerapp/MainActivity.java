package com.anmolarora.braintrainerapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void playAgain(View view){
        ...
        new CountDownTimer(30100,1000){
            ...
            public void onFinish(){
                ...
                //Counter is finished(After 30 seconds)
    ...
    public void chooseAnswer(View view){
        ...
        if (view.getTag().toString().equals(Integer.toString(locationOfCorrectAnswer))){ // equals for == when using strings
